...
const Wallet = (props: any) => (
  <Link href="/wallet">
    <div className="text-indigo-700 border border-gray-200 hover:bg-[#e4e4f8] transition-all ease-in-out delay-50 font-semibold p-2 px-7 py-2 text-2xl rounded-lg cursor-pointer absolute top-[0.80rem] right-[10.5rem]">
      Wallet
    </div>
  </Link>
);
